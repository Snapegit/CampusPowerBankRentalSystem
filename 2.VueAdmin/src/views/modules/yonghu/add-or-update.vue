	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="余额" prop="jine">
					<el-input-number v-model="ruleForm.jine" placeholder="余额" :readonly="ro.jine"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="余额" prop="jine">
					<el-input v-model="ruleForm.jine" placeholder="余额" readonly></el-input>
				</el-form-item>
			</template>

<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="归还编号" prop="guihaibianhao">
					<el-input v-model="ruleForm.guihaibianhao" placeholder="归还编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.guihaibianhao" label="归还编号" prop="guihaibianhao">
					<el-input v-model="ruleForm.guihaibianhao" placeholder="归还编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="租借时间" prop="zujieshijian">
					<el-input v-model="ruleForm.zujieshijian" placeholder="租借时间" clearable  :readonly="ro.zujieshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="租借时间" prop="zujieshijian">
					<el-input v-model="ruleForm.zujieshijian" placeholder="租借时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="时长" prop="shizhang">
					<el-input v-model="shizhang" placeholder="时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.shizhang" label="时长" prop="shizhang">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="订单状态" prop="dingdanzhuangtai">
					<el-input v-model="ruleForm.dingdanzhuangtai" placeholder="订单状态" clearable  :readonly="ro.dingdanzhuangtai"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="订单状态" prop="dingdanzhuangtai">
					<el-input v-model="ruleForm.dingdanzhuangtai" placeholder="订单状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="总金额" prop="jine">
					<el-input v-model="jine" placeholder="总金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.jine" label="总金额" prop="jine">
					<el-input v-model="ruleForm.jine" placeholder="总金额" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="金额" prop="yonghuyue">
					<el-input-number v-model="ruleForm.yonghuyue" placeholder="金额" :readonly="ro.yonghuyue"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="金额" prop="yonghuyue">
					<el-input v-model="ruleForm.yonghuyue" placeholder="金额" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	computed: {
		shizhang : {
			get: function () {
				let h = this.ruleForm
				let a = 'h.zujieshijian-h.guihaishijian'
				let n = a.split('-')
				let hour = this.getHour(h[n[0].split('h.')[1]], h[n[1].split('h.')[1]])
				this.ruleForm.shizhang = hour?hour:0
				return hour?hour:0
			}
		...
		jine:{
			get: function () {
				return 1*this.ruleForm.shizhang*this.ruleForm.xiaoshifeiyong
			}
		},
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.dingdanzhuangtai = '已归还'; 
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.jine!=''&&json.jine) || json.jine==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.yonghuyue = json.jine
						this.ro.yonghuyue = true;
					}
				} else {
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.shizhang==0){
			this.$message.error('时长不能为空')
			return false
		}
		if(this.ruleForm.guihaibianhao) {
			this.ruleForm.guihaibianhao = String(this.ruleForm.guihaibianhao)
		}
	...
	if(this.ruleForm.tupian!=null) {
      ...
      if(parseFloat(this.ruleForm.jine)>parseFloat(this.ruleForm.yonghuyue)){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `guihaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									...
									this.$message({
										...
										onClose: () => {
											...
											this.parent.guihaixinxiCrossAddOrUpdateFlag = false;
											this.parent.search();

				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yonghu','充值')" @click="chongzhixinxiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
...
import chongzhixinxiCrossAddOrUpdate from "../chongzhixinxi/add-or-update";
	export default {
		...
		methods: {
			...
			chongzhixinxiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
